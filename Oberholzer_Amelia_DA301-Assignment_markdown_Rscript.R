---
title: "Oberholzer_Amelia_DA301_Assignment_Rscript.R"
...
ordered_scatter_product_top <- head(ordered_product, 15)
...
ordered_scatter_product_bottom <- tail(ordered_product, 15)
...
Now we're going to observe how sales change over time using group_by to find the total global sales per year. 
